...
PRESETS = {
    ...
    "bold_outline": {
        "name": "Bold Outline",
        "description": "Bianco con bordo nero spesso, niente box — viral classico MrBeast / TikTok",
        "settings": {
            "font_path": "./assets/fonts/BebasNeue-Regular.ttf",
            "font_size": 78,
            "font_color": "#FFFFFF",
    ...
    "neon_cyber": {
        "name": "Neon Cyber",
        "description": "Parola chiave in cyan elettrico, bordo navy — vibe tech/futurista",
        "settings": {
            "font_path": "./assets/fonts/BebasNeue-Regular.ttf",
            "font_size": 74,
            "font_color": "#FFFFFF",
    ...
    "pink_pop": {
        "name": "Pink Pop",
        "description": "Box rosa shocking + Montserrat — stile beauty / lifestyle / fashion",
        "settings": {
            "font_path": "./assets/fonts/Montserrat-Bold.ttf",
            "font_size": 66,
            "font_color": "#FFFFFF",
    ...
    "purple_glow": {
        "name": "Purple Glow",
        "description": "Box viola + bordo navy — aesthetic SaaS / tech / business",
        "settings": {
            "font_path": "./assets/fonts/BebasNeue-Regular.ttf",
            "font_size": 76,
            "font_color": "#FFFFFF",
